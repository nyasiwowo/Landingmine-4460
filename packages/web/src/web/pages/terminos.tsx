  ...
  return (
    <div className="min-h-screen bg-[var(--bg)] text-[var(--ink)]">
      ...
      <main className="mx-auto max-w-4xl px-5 py-16">
        <h1 className="mb-2 text-3xl font-display font-extrabold">Términos y condiciones</h1>
        ...
        <div className="rounded-2xl border border-[var(--line)] bg-surface p-8 text-muted">
          <p className="text-center text-base">
            [Contenido de términos y condiciones — editar este placeholder con el texto legal correspondiente]
          </p>
        </div>
      </main>
